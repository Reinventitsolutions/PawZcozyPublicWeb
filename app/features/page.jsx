...
export default function FeaturesPage() {
    ...
    return (
        <div className="w-full flex flex-col compact:flex-col medium:flex-col expanded:flex-row large:flex-row extra-large:flex-row items-stretch justify-between h-max gap-4 p-4 compact:p-2">
            <div className="extra-large:w-3/4 flex-1 p-8 rounded-3xl bg-surface-surfaceContainerLowest flex flex-col gap-8 ">
                ...
                <div className="grid grid-cols-1 compact:grid-cols-1 compact:space-y-6 medium:grid-cols-2 expanded:grid-cols-2 large:grid-cols-2 extra-large:grid-cols-2 gap-4">
            ...
            <div className="flex items-center justify-center w-full compact:w-full medium:w-full expanded:w-1/3 large:w-1/4 extra-large:w-1/4">
                ...
                <AndroidMockup
                    screenWidth={isCompact || isMedium ? 180 : 200}
                    frameColor={"#2E3135"}
                    frameOnly
                    hideStatusBar
                    hideNavBar
